  ...
  return (
    ...
    <div className="bg-[#0f2339] text-white max-w-[1280px] mx-auto ">
      <footer className="footer p-10 ">
        ...
        <nav>
          <header className="text-white text-2xl font-medium">Quick Links</header>
        ...
        <nav>
          <header className="text-white text-2xl font-medium">For Candidate</header>
          <a className="link link-hover">User Dashboard</a>
          <a className="link link-hover">Candidates Listing</a>
          <a className="link link-hover">CV Packages</a>
          <a className="link link-hover">Candidates Login</a>
        </nav>
        <nav>
          <header className="text-white text-2xl font-medium">Get in Touch</header>
          <p className="text-base">Fusce varius, dolor tempor interdum <br /> tristiquei bibendum service life.</p>
      ...
      <footer className="footer px-10 py-4 border-t  border-base-300">
        <aside className="items-center grid-flow-col">
          ...
          <p>
            Job Hunter Ltd. <br />
            Developed By <span className="font-extrabold">Ananda Das</span>
          </p>
        </aside>
      </footer>
